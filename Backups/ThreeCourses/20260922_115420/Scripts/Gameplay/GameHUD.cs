    ...
    public class GameHUD : MonoBehaviour
    {
        ...
        public void Refresh()
        {
            ...
            if (flight)
            {
                ...
                _route.text = $"RECORRIDO  {progress:P0}   /   {gm.RingsCollected} AROS";
                ...
                _flightStatus.text = !pilot.SteeringReady ? (pilot.SteeringTracked ? "SOSTÉN EL MANDO CÓMODO..." : "SIN SEGUIMIENTO · USA EL STICK") :
                    ...
                    gm.IsTurboActive ? $"IMPULSO ACTIVO  {gm.TurboTimer:0.0}s" : "VUELO LIBRE  /  SIGUE LOS AROS";
            ...
            if (selection || gm.State == GameState.Launch)
            {
                ...
                _eyebrow.text = selection ? "01 / ELIGE TU AVIÓN" : "02 / PREPARA EL LANZAMIENTO";
            ...
            else if (gm.State == GameState.GameOver || gm.State == GameState.LevelComplete)
            {
                ...
                _title.text = _victory ? "Un vuelo para recordar." : "Cada vuelo cuenta.";
                ...
                _primaryLabel.text = "VOLVER A VOLAR";
                _footer.text = $"Aros: {gm.RingsCollected}   /   Impulsos: {gm.BoostsCollected}   /   Trigger, A o Enter para reintentar";
            }
            else
            {
                _eyebrow.text = "DEL TALLER AL CIELO";
                _title.text = "Un pliegue. Mil caminos.";
                _description.text = "Elige un avión de papel, lánzalo con tus manos y toma los mandos.\nTu próxima gran marca empieza en esta mesa.";
