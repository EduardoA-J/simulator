...
namespace AvionesPapelVR
{
    public class GameManager : MonoBehaviour
    {
        ...
        public void BeginFlightFromVrThrow(PlaneDefinition def, Vector3 velocity, Vector3? releasePosition = null)
        {
            ...
            {
                var dir = velocity.sqrMagnitude > 0.01f ? velocity.normalized : Vector3.forward;
                SpawnPlayerAt(
                    releasePosition ?? (flightStartAnchor != null ? flightStartAnchor.position : new Vector3(0f, 2f, 6f)),
        ...
        public void BeginFlight(Vector3 launchVelocity)
        {
            ...
            var start = flightStartAnchor != null ? flightStartAnchor.position : new Vector3(0f, 2f, 8f);
            if (_playerPlane == null)
                SpawnPlayerAt(start, Quaternion.identity, forLaunch: false);
            else if (!vrMode)
            {
        ...
        public void CompleteLevel() => FinishRun(true);
        ...
        public void CollectRing(bool boost)
        {
            ...
            {
                BoostsCollected++;
                ActivatePowerUp(PowerUpType.Turbo, 2f);
