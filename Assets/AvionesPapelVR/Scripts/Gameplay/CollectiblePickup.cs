    ...
    public class CollectiblePickup : MonoBehaviour
    {
        ...
        void Collect()
        {
            ...
            switch (kind)
            {
                ...
                case Kind.Turbo: gm.ActivatePowerUp(PowerUpType.Turbo); break;
                case Kind.Shield: gm.ActivatePowerUp(PowerUpType.Shield); break;
                case Kind.Triple: gm.ActivatePowerUp(PowerUpType.TripleShot); break;
