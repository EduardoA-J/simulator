...
namespace AvionesPapelVR
{
    public class LaunchController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            var course = GameManager.Instance != null ? GameManager.Instance.CourseRotation : Quaternion.identity;
            _plane.transform.position = basePos - course * Vector3.forward * pull;
            _plane.transform.rotation = course * Quaternion.Euler(-8f - _charge * 12f, 0f, 0f);
        }
        ...
        void Launch()
        {
            ...
            var vel = (GameManager.Instance != null ? GameManager.Instance.CourseRotation : Quaternion.identity) * dir * force;
